...
class AccountBalanceBalanceSection extends StatelessWidget {
  const AccountBalanceBalanceSection({super.key});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        children: [
          const BalanceRowCard(),
          const SizedBox(height: 8),
          PercentageOfYourExpenses(percentage: 0.3),
        ],
      ),
    );
  }
...
class PercentageOfYourExpenses extends StatelessWidget {
  final double percentage;

  const PercentageOfYourExpenses({super.key, required this.percentage});
