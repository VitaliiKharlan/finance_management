...
class TransactionsBalanceSection extends StatelessWidget {
  const TransactionsBalanceSection({super.key});
...
class TotalBalanceCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: const EdgeInsets.only(right: 20, top: 4, left: 20, bottom: 4),
